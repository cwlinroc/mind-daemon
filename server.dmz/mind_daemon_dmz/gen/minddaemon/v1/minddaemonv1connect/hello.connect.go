...
package minddaemonv1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "mind_daemon_dmz/gen/minddaemon/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HelloServiceName = "minddaemon.v1.HelloService"
)
...
const (
	...
	HelloServiceSayHelloProcedure = "/minddaemon.v1.HelloService/SayHello"
)

// HelloServiceClient is a client for the minddaemon.v1.HelloService service.
type HelloServiceClient interface {
	SayHello(context.Context, *connect.Request[v1.HelloRequest]) (*connect.Response[v1.HelloReply], error)
}

// NewHelloServiceClient constructs a client for the minddaemon.v1.HelloService service. By default,
...
func NewHelloServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HelloServiceClient {
	...
	helloServiceMethods := v1.File_minddaemon_v1_hello_proto.Services().ByName("HelloService").Methods()
...
// SayHello calls minddaemon.v1.HelloService.SayHello.
func (c *helloServiceClient) SayHello(ctx context.Context, req *connect.Request[v1.HelloRequest]) (*connect.Response[v1.HelloReply], error) {
	return c.sayHello.CallUnary(ctx, req)
}

// HelloServiceHandler is an implementation of the minddaemon.v1.HelloService service.
...
func NewHelloServiceHandler(svc HelloServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/minddaemon.v1.HelloService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHelloServiceHandler) SayHello(context.Context, *connect.Request[v1.HelloRequest]) (*connect.Response[v1.HelloReply], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("minddaemon.v1.HelloService.SayHello is not implemented"))
}
